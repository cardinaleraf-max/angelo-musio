      ...
      <div className="container-editorial grid gap-12 md:grid-cols-12 items-center">
        <div className="md:col-span-4">
          ...
          <div className="mt-4 flex items-baseline gap-4">
            <span className="font-serif text-7xl leading-none text-sea">{property.rating.score.toFixed(1)}</span>
            <div>
          ...
          {property.rating.categories.map((c) => (
            <div key={c.label} className="border-b border-border/60 pb-4">
              <div className="flex justify-between items-baseline">
                ...
                <span className="font-serif text-2xl text-sea">{c.value.toFixed(1)}</span>
              </div>
